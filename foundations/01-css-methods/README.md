...
### Self Check
- Did you use all three methods of adding CSS to an HTML file? yes, but still used div on inline
...
- Does the `button` element have CSS added via the inline method? yes, but still used div(no need)
